...
levels(Presidentti2012.df$Sukupuoli) <- c("NULL", "Nainen", "Mies")
levels(Presidentti2012.df$Ykkosehdokas) <- sapply(candidates$data, function(x) x$lastname)
...
stats.grob <- do.call(arrangeGrob, c(stats.plots, list(ncol=3)))
ggsave("vaalit/Presidentti2012_Vastaajatilastoja_20120106.png", plot=stats.grob, width=17, height=8)
